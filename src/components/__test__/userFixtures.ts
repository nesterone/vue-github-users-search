export const userFixtures = {
    ...
    rateLimitingError() {
        return {
            "message": "API rate limit exceeded for 94.31.96.157. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)",
